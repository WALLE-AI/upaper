...
class PaperFileDownloadAndParser:
    ...
    @staticmethod
    def parse(paper_id: str, pdf_file_root: str) -> Dict[str, Any]:
...
if __name__ == "__main__":
    paper_id = PaperFileDownloadAndParser.get_papers_id_list()[1:5]
    pdf_file_root = "hf_papers"
    for pid in paper_id:
        result = PaperFileDownloadAndParser.parse(pid, pdf_file_root)
