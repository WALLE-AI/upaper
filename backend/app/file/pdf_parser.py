...
client = MinerUClient(
    ...
    server_url=os.getenv("MINERU_SERVER")
)
...
def pdf_parser_run(output_dir:str,file_path:str):
    logger.info("file parser start:",file_path)
    async def main():
        return await parse_doc([file_path], output_dir, backend="vlm-miner2.5")
...
if __name__ == '__main__':
    ...
    output_dir="hf_papers/"
    doc_path_list = ["hf_papers/2511.02778/2511.02778.pdf"]
