...
from .firecrawl_app import FirecrawlApp
...
class WebsiteService:
    ...
    def crawl_url(cls, args: dict) -> dict:
        ...
        if provider == "firecrawl":
            ...
            # )
            firecrawl_app = FirecrawlApp(api_key=apk_key, base_url=url)
    ...
    def get_crawl_status(cls, job_id: str, provider: str) -> dict:
        if provider == "firecrawl":
            # decrypt api_key
            firecrawl_app = FirecrawlApp(api_key=cls.api_key, base_url=cls.url)
